...
public class Table {
    ...
    public List<WebElement> getHeadings() {
        WebElement rowHeadings = tableElement.findElement(By.xpath(".//tr[1]"));
        List<WebElement> headingsColomns = tableElement.findElements(By.xpath(".//th"));
        return headingsColomns;
    }
